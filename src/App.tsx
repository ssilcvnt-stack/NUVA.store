                    ...
                    <table className="w-full text-left font-mono text-[9px] text-neutral-500 border-collapse select-text">
                      <thead>
                        <tr className="border-b border-neutral-200">
                          ...
                          <th className="py-1.5 uppercase font-medium">peito / largura</th>
                          <th className="py-1.5 uppercase font-medium">comprimento</th>
                          <th className="py-1.5 uppercase font-medium">manga</th>
                        </tr>
                      </thead>
                      <tbody>
                        {SIZE_TABLE.map((row) => (
                          <tr key={row.size} className="border-b border-neutral-100">
                            <td className="py-2.5 font-semibold text-neutral-800">{row.size}</td>
      ...
      <footer className="bg-neutral-50 text-neutral-800 pt-20 pb-16 select-none border-t border-neutral-200" id="main-footer">
        <div className="max-w-4xl mx-auto px-4 flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex items-center justify-center space-x-6 text-neutral-800">
            <a href="https://www.instagram.com/brancodiamante.joalheria/" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-500 transition-colors">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="https://www.facebook.com/nuva.sho" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-500 transition-colors">
