                ...
                <div className="pt-4 border-t border-neutral-200">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (!firstName || !lastName || !email || !phone || !address || !city) {
                        setValidationError("Por favor, preencha todos os dados de entrega obrigatórios para avançar ou enviar o pedido.");
                        return;
                      }
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      const orderDetails = `Olá! Gostaria de fazer uma encomenda. Aqui estão os meus dados de entrega:\n\nNome: ${firstName} ${lastName}\nEmail: ${email}\nTelemóvel: ${phone}\nMorada: ${address}\nCódigo Postal: ${postalCode || "N/A"}\nCidade: ${city}\nPaís: ${country}\n\nResumo do Pedido:\n` + 
                      ...
                      window.open(`https://wa.me/244941429171?text=${encodeURIComponent(orderDetails)}`, '_blank');
                    }}
                    className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white py-4 mt-3 text-[11px] uppercase tracking-[0.2em] transition-colors flex items-center justify-center gap-2 font-semibold"
                    id="whatsapp-step1-checkout-btn"
                  >
